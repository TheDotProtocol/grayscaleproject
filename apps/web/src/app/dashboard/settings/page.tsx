              ...
              <button
                ...
                className={cn(
                  ...
                  isDefault
                    ...
                    : "bg-white/[0.06] text-foreground/80 hover:bg-white/[0.08]",
                )}
              >
      ...
      <div className="mt-6 glass-card p-6">
        ...
        {prefs && (
          <div className="space-y-4">
                ...
                {(["dark", "light", "system"] as const).map((theme) => (
                  <button
                    ...
                    className={cn(
                      ...
                      prefs.theme === theme ? "border-primary/50 bg-primary/10 text-primary" : "border-white/10 text-muted-foreground",
                    )}
                  >
            ...
            <div>
              <p className="mb-2 text-sm text-muted-foreground">Default Executive</p>
              <select
